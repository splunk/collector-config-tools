...
class C3FieldsetSliceFormController {
  ...
  constructor(sb, cfgSchema, multiFieldsetView, onSubmit) {
    ...
    this.rootView = new C3FieldsetFormView(cfgSchema["name"], this.sb);
  ...
  addField() {
    const fieldView = new C3FieldView(this.sb, this.cfgSchema["type"] + " element");
