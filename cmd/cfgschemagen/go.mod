module github.com/splunk/collector-config-tools/cmd/cfgschemagen

go 1.19

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/configschema v0.0.0
...
//replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/configschema => ../../../../open-telemetry/opentelemetry-collector-contrib/pkg/configschema
